...
//		this.Nh = Nh;
	...
	public void playFile(int index) {
		try {
			// this directory might change depending mine starts with
			// "C:/Users/elvis/Documents/Notes" + "/Note" + index + ".wav"
...
//					OpenedFile.startPlaying();
	...
	public void startRecording() {
		JOptionPane.showMessageDialog(null,
				"Recording starts the instant you start playing and ends when save pressed!");
		recordPressed = true;
		start();
